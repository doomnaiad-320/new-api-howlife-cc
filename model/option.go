...
func InitOptionMap() {
	...
	common.OptionMap["RouterMode"] = operation_setting.NormalizeRouterMode(operation_setting.RouterMode)
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "RouterMode":
		operation_setting.RouterMode = operation_setting.NormalizeRouterMode(value)
